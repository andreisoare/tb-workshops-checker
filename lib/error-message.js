...
ErrorMessage.upgradeRequired =
  ...
  , 'Please update by following the instructions below:\n'
  , 'For OSX'
  , 'npm install -g talentbuddy\n'
  , 'For Windows'
  , 'npm install talentbuddy\n'
  , 'For Ubuntu'
  , 'sudo npm install -g talentbuddy'
  ].join('\n')
...
ErrorMessage.workshopNotFound =
  [ 'Ooops, the workshop you\'ve specified doesn\'t exist.\n'
  , 'Please make sure you\'re using the setup command described in the first task of this workshop.\n'
  , this.emailUs
  ].join('\n')
