...
error.CheckerError = function(message) {
  ...
  this.message = message || 'Something went wrong. Please try again in a few seconds.'
...
error.ServerError = function(message) {
  Error.call(this)
  Error.captureStackTrace(this, arguments.callee)
  this.message = message || 'Talentbuddy server could not process your request. Please try again in a few seconds.'
